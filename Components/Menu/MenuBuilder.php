...
namespace Modules\Dashboard\Components\Menu;
...
class MenuBuilder implements Countable
{
     ...
     * @param  string $key
     * @param  string $value
     * @return \Modules\Dashboard\Components\Menu\MenuItem
     */
     ...
     *
     * @return \Modules\Dashboard\Components\Menu\Presenters\PresenterInterface
     */
